    ...
    <div>
      ...
      <div className="mb-5 grid gap-4 sm:grid-cols-3">
        <section className="card-surface p-4">
          <p className="text-xs font-bold uppercase tracking-wide text-muted-foreground">Eventos</p>
          <p className="mt-2 font-serif text-3xl font-bold">{rows.length}</p>
        </section>
        <section className="card-surface p-4">
          <p className="text-xs font-bold uppercase tracking-wide text-muted-foreground">Processados</p>
          <p className="mt-2 font-serif text-3xl font-bold text-emerald-700">{processed}</p>
        </section>
        <section className="card-surface p-4">
          <p className="text-xs font-bold uppercase tracking-wide text-muted-foreground">Para conferir</p>
          <p className="mt-2 font-serif text-3xl font-bold text-amber-700">{pending}</p>
        </section>
      </div>
